...
goog.exportSymbol('proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig', null, global);
goog.exportSymbol('proto.pulumirpc.EnforcementLevel', null, global);
goog.exportSymbol('proto.pulumirpc.PolicyInfo', null, global);
goog.exportSymbol('proto.pulumirpc.PolicyInfo.ConfigInfo', null, global);
...
proto.pulumirpc.PolicyInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    config: (f = msg.getConfig()) && proto.pulumirpc.PolicyInfo.ConfigInfo.toObject(includeInstance, f)
  };
...
proto.pulumirpc.PolicyInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.pulumirpc.PolicyInfo.ConfigInfo;
      reader.readMessage(value,proto.pulumirpc.PolicyInfo.ConfigInfo.deserializeBinaryFromReader);
      msg.setConfig(value);
      break;
    default:
      reader.skipField();
...
proto.pulumirpc.PolicyInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.pulumirpc.PolicyInfo.ConfigInfo.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.pulumirpc.PolicyInfo.ConfigInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pulumirpc.PolicyInfo.ConfigInfo.repeatedFields_, null);
};
goog.inherits(proto.pulumirpc.PolicyInfo.ConfigInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.pulumirpc.PolicyInfo.ConfigInfo.displayName = 'proto.pulumirpc.PolicyInfo.ConfigInfo';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.PolicyInfo.ConfigInfo.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.PolicyInfo.ConfigInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.PolicyInfo.ConfigInfo}
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.PolicyInfo.ConfigInfo;
  return proto.pulumirpc.PolicyInfo.ConfigInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.PolicyInfo.ConfigInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.PolicyInfo.ConfigInfo}
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.PolicyInfo.ConfigInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.PolicyInfo.ConfigInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!Array.<string>}
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.getRequiredList = function() {
  return /** @type {!Array.<string>} */ (jspb.Message.getRepeatedField(this, 2));
};


/** @param {!Array.<string>} value */
proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.setRequiredList = function(value) {
  jspb.Message.setField(this, 2, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.addRequired = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};


proto.pulumirpc.PolicyInfo.ConfigInfo.prototype.clearRequiredList = function() {
...
/**
 * optional ConfigInfo config = 6;
 * @return {?proto.pulumirpc.PolicyInfo.ConfigInfo}
 */
proto.pulumirpc.PolicyInfo.prototype.getConfig = function() {
  return /** @type{?proto.pulumirpc.PolicyInfo.ConfigInfo} */ (
    jspb.Message.getWrapperField(this, proto.pulumirpc.PolicyInfo.ConfigInfo, 6));
};


/** @param {?proto.pulumirpc.PolicyInfo.ConfigInfo|undefined} value */
proto.pulumirpc.PolicyInfo.prototype.setConfig = function(value) {
  jspb.Message.setWrapperField(this, 6, value);
};


proto.pulumirpc.PolicyInfo.prototype.clearConfig = function() {
 ...
 * @return {!boolean}
 */
proto.pulumirpc.PolicyInfo.prototype.hasConfig = function() {
  return jspb.Message.getField(this, 6) != null;
};
...
proto.pulumirpc.ConfigureAnalyzerRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    policyconfigMap: (f = msg.getPolicyconfigMap()) ? f.toObject(includeInstance, proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.toObject) : []
  };
...
proto.pulumirpc.ConfigureAnalyzerRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.deserializeBinaryFromReader);
         });
      break;
    default:
      reader.skipField();
...
proto.pulumirpc.ConfigureAnalyzerRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.serializeBinaryToWriter);
  }
};
 ...
 * @constructor
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.displayName = 'proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig';
}
 ...
 * @return {!Object}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    enforcementlevel: jspb.Message.getFieldWithDefault(msg, 1, 0),
    enforcementleveldefined: jspb.Message.getFieldWithDefault(msg, 2, false),
    properties: (f = msg.getProperties()) && google_protobuf_struct_pb.Struct.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig;
  return proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setEnforcementleveldefined(value);
      break;
    case 3:
      var value = new google_protobuf_struct_pb.Struct;
      reader.readMessage(value,google_protobuf_struct_pb.Struct.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEnforcementlevel();
  if (f !== 0.0) {
    writer.writeEnum(
  ...
  f = message.getEnforcementleveldefined();
  if (f) {
    writer.writeBool(
      2,
      f
 ...
 * @return {!proto.pulumirpc.EnforcementLevel}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.getEnforcementlevel = function() {
  return /** @type {!proto.pulumirpc.EnforcementLevel} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.pulumirpc.EnforcementLevel} value */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.setEnforcementlevel = function(value) {
  jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional bool enforcementLevelDefined = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.getEnforcementleveldefined = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.setEnforcementleveldefined = function(value) {
 ...
 * @return {?proto.google.protobuf.Struct}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.getProperties = function() {
  return /** @type{?proto.google.protobuf.Struct} */ (
...
/** @param {?proto.google.protobuf.Struct|undefined} value */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.setProperties = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.clearProperties = function() {
  this.setProperties(undefined);
};
 ...
 * @return {!boolean}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig.prototype.hasProperties = function() {
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig>}
 */
proto.pulumirpc.ConfigureAnalyzerRequest.prototype.getPolicyconfigMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.pulumirpc.ConfigureAnalyzerRequest.PolicyConfig));
};
