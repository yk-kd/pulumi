...
class RegisterResourceRequest(google.protobuf.message.Message):
    ...
    def transformations(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """a list of transformation callback references; present when remote is true."""
    def __init__(
        self,
        *,
        type: builtins.str = ...,
