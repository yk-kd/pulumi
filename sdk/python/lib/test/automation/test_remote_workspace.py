...
@pytest.mark.parametrize("error,stack_name,url,branch,commit_hash,auth", [
    ...
    ('"name" stack name must be fully qualified.', "name", "", None, None, None),
    ('"owner/name" stack name must be fully qualified.', "owner/name", "", None, None, None),
    ('"/" stack name must be fully qualified.', "/", "", None, None, None),
    ('"//" stack name must be fully qualified.', "//", "", None, None, None),
    ('"///" stack name must be fully qualified.', "///", "", None, None, None),
    ('"owner/project/stack/wat" stack name must be fully qualified.', "owner/project/stack/wat", "", None, None, None),
    ('url is required.', "owner/project/stack", None, None, None, None),
    ('url is required.', "owner/project/stack", "", None, None, None),
    ('at least commit_hash or branch are required.', "owner/project/stack", test_repo, None, None, None),
    ('at least commit_hash or branch are required.', "owner/project/stack", test_repo, "", "", None),
    ('commit_hash and branch cannot both be specified.', "owner/project/stack", test_repo, "branch", "commit", None),
