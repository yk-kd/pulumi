...
func NewResource(ctx *pulumi.Context,
	...
	if args.Config != nil {
		args.Config = pulumi.ToSecret(args.Config.ToConfigOutput()).(ConfigOutput)
	}
	if args.ConfigArray != nil {
		args.ConfigArray = pulumi.ToSecret(args.ConfigArray.ToConfigArrayOutput()).(ConfigArrayOutput)
	}
	if args.ConfigMap != nil {
		args.ConfigMap = pulumi.ToSecret(args.ConfigMap.ToConfigMapOutput()).(ConfigMapOutput)
	}
	if args.Foo != nil {
		args.Foo = pulumi.ToSecret(args.Foo.ToStringOutput()).(pulumi.StringOutput)
	}
	if args.FooArray != nil {
		args.FooArray = pulumi.ToSecret(args.FooArray.ToStringArrayOutput()).(pulumi.StringArrayOutput)
	}
	if args.FooMap != nil {
		args.FooMap = pulumi.ToSecret(args.FooMap.ToStringMapOutput()).(pulumi.StringMapOutput)
	}
